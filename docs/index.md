...
synthesis, and Goertzel primitives in `opentone._audio`. The core schemes have no
...
DTMF, Morse, FSK, and MF move small amounts of data, such as a short URL or
code, over an audio channel between devices, or carry an accessibility cue in
sound. SSTV and spectrogram art carry images. Watermarking hides a payload
inside other audio.
